...
void AdNotifications::SaveState() {
  ...
  VLOG(5, "Saving ad notifications state");
...
void AdNotifications::OnStateSaved(
  ...
  VLOG(5, "Successfully saved ad notifications state");
}
...
void AdNotifications::OnStateLoaded(
  ...
  if (result != SUCCESS) {
    VLOG(2, "Initializing ad notifications state");
    ...
    VLOG(4, "Successfully loaded ad notifications state");
  }
